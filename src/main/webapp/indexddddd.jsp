...
<div class="wrap">
	<div class="header">
		<div class="logo">
			<a href="index.html" style="background:none;">公司文化</a>
		</div>
	<div style="float:right;position: relative;">注册/登陆</div>
		<div>
			<div style="text-align: center;width:30%;margin:0 auto;">
			<ul style="list-style:none;margin: 0px;padding: 0px;width: auto;">
				<li style="float:left;width:33.33%;">有趣</li>
				<li style="float:left;width:33.33%;">创造</li>
				<li style="float:left;width:33.33%;">简单</li>
			</ul>
			</div>
		</div>
	...
	<div class="header_right">
		...
		<div class="menu_box_list" style="width: 80%;margin: 0 auto;">
				<ul>
					<li>森田的路</li>
					<li>森田的路</li>
					<li>森田的路</li>
			...
			<div class="menu_box_list">
				<ul>
					...
					<li class="color2"><a href="service.html"> <i class="icon2"> </i> <span>Service</span></a></li>
			  		...
			  		<li class="color5"><a href="travel_guide.html"> <i class="icon5"> </i> <span>how to</span></a></li>
...
<div class="wrap">
	<div class="top_grids">
		...
		<div class="top_map">
			<ul>
				<li><img src="static/images/map.png" alt="" /> </li>
				<li><img src="static/images/map1.png" alt="" /> </li>
			</ul>
		</div>
	...
	<div class="content">
		...
		<!-- start content_slider -->
		       <div id="owl-demo" class="owl-carousel">
	                <div class="item"><img class="lazyOwl" data-src="static/images/owl1.jpg" alt="Lazy Owl Image">
	                	<h2 class="img_slider"><a href="#">Josh Jansen</a></h2>
	                	<p class="img_slider"><a href="#">digital producer</a></p>
	                </div>
	                <div class="item"><img class="lazyOwl" data-src="static/images/owl2.jpg" alt="Lazy Owl Image">
	                	<h2 class="img_slider"><a href="#">blaz robar</a></h2>
	                	<p class="img_slider"><a href="#">Designer</a></p>
	                </div>
	                <div class="item"><img class="lazyOwl" data-src="static/images/owl3.jpg" alt="Lazy Owl Image">
	                	<h2 class="img_slider"><a href="#">james brown</a></h2>
	                	<p class="img_slider"><a href="#">Developer</a></p>
	                </div>
	                <div class="item"><img class="lazyOwl" data-src="static/images/owl4.jpg" alt="Lazy Owl Image">
